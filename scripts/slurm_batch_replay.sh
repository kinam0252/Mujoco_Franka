#!/bin/bash
#SBATCH --job-name=mj_replay
#SBATCH --partition=core
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --time=2:00:00
#SBATCH --array=0-9
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_replay_%A_%a.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_replay_%A_%a.err
...
# ── Split episodes across array tasks (10 workers × ~5 episodes each) ──
